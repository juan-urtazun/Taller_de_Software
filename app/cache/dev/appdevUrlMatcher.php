...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            // admin_medicina_kernel_oficina_list
            if ($pathinfo === '/admin/medicina/kernel/oficina/list') {
                return array (  '_controller' => 'Medicina\\BackendBundle\\Controller\\OficinaAdminController::listAction',  '_sonata_admin' => 'backend.admin.oficina',  '_sonata_name' => 'admin_medicina_kernel_oficina_list',  '_route' => 'admin_medicina_kernel_oficina_list',);
            }

            // admin_medicina_kernel_oficina_create
            if ($pathinfo === '/admin/medicina/kernel/oficina/create') {
                return array (  '_controller' => 'Medicina\\BackendBundle\\Controller\\OficinaAdminController::createAction',  '_sonata_admin' => 'backend.admin.oficina',  '_sonata_name' => 'admin_medicina_kernel_oficina_create',  '_route' => 'admin_medicina_kernel_oficina_create',);
            }

            // admin_medicina_kernel_oficina_batch
            if ($pathinfo === '/admin/medicina/kernel/oficina/batch') {
                return array (  '_controller' => 'Medicina\\BackendBundle\\Controller\\OficinaAdminController::batchAction',  '_sonata_admin' => 'backend.admin.oficina',  '_sonata_name' => 'admin_medicina_kernel_oficina_batch',  '_route' => 'admin_medicina_kernel_oficina_batch',);
            }

            // admin_medicina_kernel_oficina_edit
            if (0 === strpos($pathinfo, '/admin/medicina/kernel/oficina') && preg_match('#^/admin/medicina/kernel/oficina/(?P<id>[^/]+?)/edit$#s', $pathinfo, $matches)) {
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Medicina\\BackendBundle\\Controller\\OficinaAdminController::editAction',  '_sonata_admin' => 'backend.admin.oficina',  '_sonata_name' => 'admin_medicina_kernel_oficina_edit',)), array('_route' => 'admin_medicina_kernel_oficina_edit'));
            }

            // admin_medicina_kernel_oficina_delete
            if (0 === strpos($pathinfo, '/admin/medicina/kernel/oficina') && preg_match('#^/admin/medicina/kernel/oficina/(?P<id>[^/]+?)/delete$#s', $pathinfo, $matches)) {
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Medicina\\BackendBundle\\Controller\\OficinaAdminController::deleteAction',  '_sonata_admin' => 'backend.admin.oficina',  '_sonata_name' => 'admin_medicina_kernel_oficina_delete',)), array('_route' => 'admin_medicina_kernel_oficina_delete'));
            }

            // admin_medicina_kernel_oficina_show
            if (0 === strpos($pathinfo, '/admin/medicina/kernel/oficina') && preg_match('#^/admin/medicina/kernel/oficina/(?P<id>[^/]+?)/show$#s', $pathinfo, $matches)) {
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Medicina\\BackendBundle\\Controller\\OficinaAdminController::showAction',  '_sonata_admin' => 'backend.admin.oficina',  '_sonata_name' => 'admin_medicina_kernel_oficina_show',)), array('_route' => 'admin_medicina_kernel_oficina_show'));
            }

            // admin_medicina_kernel_oficina_export
            if ($pathinfo === '/admin/medicina/kernel/oficina/export') {
                return array (  '_controller' => 'Medicina\\BackendBundle\\Controller\\OficinaAdminController::exportAction',  '_sonata_admin' => 'backend.admin.oficina',  '_sonata_name' => 'admin_medicina_kernel_oficina_export',  '_route' => 'admin_medicina_kernel_oficina_export',);
            }

            // admin_medicina_kernel_oficina_history
            if (0 === strpos($pathinfo, '/admin/medicina/kernel/oficina') && preg_match('#^/admin/medicina/kernel/oficina/(?P<id>[^/]+?)/history$#s', $pathinfo, $matches)) {
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Medicina\\BackendBundle\\Controller\\OficinaAdminController::historyAction',  '_sonata_admin' => 'backend.admin.oficina',  '_sonata_name' => 'admin_medicina_kernel_oficina_history',)), array('_route' => 'admin_medicina_kernel_oficina_history'));
            }

            // admin_medicina_kernel_oficina_history_view_revision
            if (0 === strpos($pathinfo, '/admin/medicina/kernel/oficina') && preg_match('#^/admin/medicina/kernel/oficina/(?P<id>[^/]+?)/history/(?P<revision>[^/]+?)/view$#s', $pathinfo, $matches)) {
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Medicina\\BackendBundle\\Controller\\OficinaAdminController::historyViewRevisionAction',  '_sonata_admin' => 'backend.admin.oficina',  '_sonata_name' => 'admin_medicina_kernel_oficina_history_view_revision',)), array('_route' => 'admin_medicina_kernel_oficina_history_view_revision'));
            }
        ...
        // sonata_user_admin_change_password
        if ($pathinfo === '/change-password/change-password') {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                goto not_sonata_user_admin_change_password;
            }
            return array (  '_controller' => 'Sonata\\UserBundle\\Controller\\ChangePasswordController::changePasswordAction',  '_route' => 'sonata_user_admin_change_password',);
        }
        not_sonata_user_admin_change_password:
